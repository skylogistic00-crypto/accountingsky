...
export default function PermohonanDanaForm({ onSuccess }: PermohonanDanaFormProps) {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Berhasil!',
        description: 'Permohonan dana berhasil dibuat dan jurnal entries telah dicatat.',
      });
      ...
      toast({
        title: 'Error',
        description: error.message || 'Terjadi kesalahan saat membuat permohonan dana',
        variant: 'destructive',
      });
    } finally {
      setLoading(false);
  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md mx-auto">
      <h2 className="text-3xl font-bold text-slate-800 mb-8">Form Permohonan Dana</h2>
      
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <Label htmlFor="nama_pemohon" className="text-slate-700 font-medium mb-2 block">
            Nama Pemohon
          </Label>
          <Input
            id="nama_pemohon"
        ...
        <div>
          <Label htmlFor="departemen" className="text-slate-700 font-medium mb-2 block">
            Departemen
          </Label>
          <Input
            id="departemen"
        ...
        <div>
          <Label htmlFor="tanggal_permohonan" className="text-slate-700 font-medium mb-2 block">
            Tanggal Permohonan
          </Label>
        ...
        <div>
          <Label htmlFor="jumlah" className="text-slate-700 font-medium mb-2 block">
            Jumlah
          </Label>
          <div className="relative">
        ...
        <div>
          <Label htmlFor="keterangan" className="text-slate-700 font-medium mb-2 block">
            Keterangan
          </Label>
          <Textarea
            id="keterangan"
